...
(function() {
  var BEST_URL, BLOCKS, BLOCK_ELEMENTS, COMMENT_NODE, DEBUG, ELEMENT_NODE, IRRELEVANT_ELEMENTS, JQ, JQUERY_UI_CSS, MIN_LINK_RATIO, NAV_CONTAINING_ELEMENTS, PUNCTUATION, QUOTES, SECTION, SHORTENABLE_WORDS, TEXTISH_ELEMENTS, TEXT_NODE, WORD_REGEX, debug, examinedoc, getBestURL, key, value,
  ...
  examinedoc = (function() {
    ...
    for (key in _ref) {
      value = _ref[key];
      _results.push(debug("\t" + key + " is " + value + "\n"));
    }
    return _results;
  })();
