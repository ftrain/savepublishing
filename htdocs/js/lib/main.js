...
(function() {
  var BLOCKS, BLOCK_ELEMENTS, COMMENT_NODE, DEBUG, ELEMENT_NODE, IRRELEVANT_ELEMENTS, JQ, JQUERY_UI_CSS, MIN_LINK_RATIO, NAV_CONTAINING_ELEMENTS, PUNCTUATION, QUOTES, SECTION, SHORTENABLE_WORDS, TEXTUAL_ELEMENTS, TEXT_NODE, WORD_REGEX, debug, key,
  ...
  Node.prototype.isFirstText = function() {
    var _ref;
    return this.isTextish() && !((_ref = this.previousSibling) != null ? _ref.isTextish() : void 0);
  };
  ...
  Node.prototype.isUseful = function() {
    ...
    return !(this.isWhitespace() || this.isComment() || this.isIrrelevant() || this.isLinkish());
  };
  ...
  Node.prototype.concatenateTextDestructively = function(array) {
    ...
    if (this.isUseful() && this.isTextish()) {
  ...
  Node.prototype.unwrap = function() {
    var node, span, spans, statement, statements, _i, _j, _len, _len1, _ref, _results;
    if (this.isFirstText()) {
      ...
      for (_i = 0, _len = statements.length; _i < _len; _i++) {
        ...
        span = "<span class=\"socialtext\"><a class=\"" + (statement.length < 120) + "\" href=\"https://twitter.com/intent/tweet?text=“" + (statement.clean()) + "” " + location.href + "\">" + (statement.clean()) + "</a></span>";
        spans.push(span);
      }
      return JQ(this).replaceWith(JQ('<span class="socialtext-set"/>').append(spans.join("")));
