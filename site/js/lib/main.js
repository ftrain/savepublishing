...
(function() {
  var BLOCKS, BLOCK_ELEMENTS, ELEMENT_NODE, IGNORABLE_ELEMENTS, JQ, NAV_CONTAINING_ELEMENTS, NAV_RATIO, PUNCTUATION, QUOTES, SHORTENABLE_WORDS, SocialString, TEXTUAL_ELEMENTS, TEXT_NODE, WORD_REGEX, key,
  ...
  Node.prototype.isElement = function() {
    return this.nodeType === ELEMENT_NODE;
  };

  Node.prototype.isIgnorable = function() {
    var _ref;
    return this.isElement && (_ref = this.nodeName, __indexOf.call(IGNORABLE_ELEMENTS, _ref) >= 0);
  };
  ...
  Node.prototype.isLinkish = function() {
    var as, as_len, node_len, rat, _ref;
    if ((typeof this !== "undefined" && this !== null) && (_ref = this.nodeName, __indexOf.call(NAV_CONTAINING_ELEMENTS, _ref) >= 0)) {
      as = JQ(this).children('a');
      if (as.length > 0) {
        as_len = as.text().length;
        node_len = JQ(this).text().length;
        rat = node_len / as_len;
  ...
  Node.prototype.unwrap = function() {
    ...
    if (this.isTextish() && this.isUseful() && !(this.isIgnorable() || this.isLinkish())) {
