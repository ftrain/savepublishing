...
(function() {
  var BEST_URL, BLOCKS, BLOCK_ELEMENTS, COMMENT_NODE, DEBUG, ELEMENT_NODE, IRRELEVANT_ELEMENTS, JQ, JQUERY_UI_CSS, MAX_STRING_LENGTH, MIN_LINK_RATIO, NAV_CONTAINING_ELEMENTS, PUNCTUATION, QUOTES, SECTION, SHORTENABLE_WORDS, TEXTISH_ELEMENTS, TEXT_NODE, WORD_REGEX, debug, getBestURL, key,
  ...
  String.prototype.enTweeten = function() {
    ...
    length = after.length;
    short = length <= MAX_STRING_LENGTH;
  ...
  Document.prototype.styles = function() {
  ...
  Document.prototype.widget = function() {
  ...
  if (Document.prototype.body && Document.prototype.run) {
    document.run();
  } else {
    JQ(document).ready(Document.prototype.run);
  }
