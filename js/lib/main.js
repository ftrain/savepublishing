...
require(["jquery", "twidgets", "ui", "socialtext"], function ($) {
    ...
    $(function () {
        ...
        $('#socialtext-wrapper').css({'text-align':'center',
                                         'width':'100%',
                                         'position':'fixed',
                                         'opacity':'1',
                                         'line-height':'200%',
        ...
        $('.socialtext-checkbox').css({'cursor':'pointer'});

        $('.socialtext-checkbox:input').css({'cursor':'pointer'});

        $('#socialtext-reset').css({
                                       'text-align':'right',
                                       'margin':'-1em -.5em 0 0'

                                   });

        $('#socialtext-wrapper').css({
                                         'color':'#ccc',
        ...
        $('a.socialtext-show:after').css({'content':'"\2605"'});

        $('a.socialtext-hide').css({
                                       'text-decoration':'none',
                                       'background':'white',
                                       'color':'silver',
                                       'margin-right':'.5em'
