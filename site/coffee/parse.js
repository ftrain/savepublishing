...
(function() {
  var ELEMENT_NODE, TEXT_NODE, blockElements, blocks, textualElements, unwrap,
  ...
  blockElements = ['H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'BODY'];

  textualElements = ['SPAN', 'A', 'EM', 'B', 'STRONG', 'I'];
  ...
  Node.prototype.isTextual = function() {
    var _ref;
    return (this.nodeType === ELEMENT_NODE) && (_ref = this.nodeName, __indexOf.call(textualElements, _ref) >= 0);
  };
  ...
  Node.prototype.isBlockLike = function() {
    var _ref, _ref1;
    return (_ref = $(this).css('display'), __indexOf.call(blocks, _ref) >= 0) || (_ref1 = this.nodeName, __indexOf.call(blockElements, _ref1) >= 0);
  };
