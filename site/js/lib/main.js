...
(function() {
  ...
  Node.prototype.empty = function() {
    if (this.isText()) {
      ...
      return ___jQuery(this).html("");
    }
  };

  Node.prototype.isBlockLike = function() {
    var _ref, _ref1;
    return (_ref = ___jQuery(this).css('display'), __indexOf.call(blocks, _ref) >= 0) || (_ref1 = this.nodeName, __indexOf.call(BLOCK_ELEMENTS, _ref1) >= 0);
  };
  ...
  Node.prototype.concatenateTextDestructively = function(array) {
    ...
    if (this.isTextish()) {
      if (this.isUseful()) {
        array.push(___jQuery(this).text());
      }
      this.empty();
  ...
  Node.prototype.unwrap = function() {
    ...
    if (this.isTextish() && this.isUseful() && !((_ref = this.previousSibling) != null ? _ref.isTextish() : void 0)) {
      return ___jQuery(this).replaceWith(___jQuery('<span class="socialtext-set"/>').append(((function() {
  ...
  String.prototype.squeeze = function() {
    ...
    }).replace(/\s+the\s+/g, " ").replace(/(without)/g, "w/out").replace(/e(r|d)(\W)/g, "___jQuery1___jQuery2").replace(RegExp(" has", "g"), "'s ").replace(/est/g, "st").replace(/\sam\b/g, "’m").replace(/\b(will|shall)/g, "’ll").replace(/\bnot/g, "n’t").replace(/e(r|n)(\b)/g, "___jQuery1___jQuery2").replace(/\sfor/g, " 4").replace(RegExp(" have", "g"), "'ve").replace(/(1[0-9]|20)/g, function(a) {
      return "&#" + (parseInt(a) + 9311) + ";";
    });
  };

  String.prototype.textToLink = function() {
    return ___jQuery("<a href=\"http://twitter.com" + (encodeURI(this)) + "\">" + this + "#</a>");
  };
  ...
  (function($) {
    return $(function() {
      return $(document).ready(function() {
        ...
        ___jQuery(".socialtext").css({
          cursor: 'pointer'
        });
        return ___jQuery(".socialtext").click(function() {
